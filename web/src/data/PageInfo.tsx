...
export const pageInfo: PageDataType = {
  ...
  about: {
    ...
    personalResume: {
      ...
      resume: {
        en: "Hello, let me introduce myself. My name is Mario Elvio, I'm 28 years old, I live in Araraquara which is a city in the countryside of São Paulo. I consider myself an extremely calm and observing person, I love spending my free time with my family, reading and studying things that brings me some knowledge, I love watching science fiction movies and series. My passion for technology started when I was 6 years old. At that age I got my first computer which was very old, but it was enough to hold me in this incredible digital world. In 2020 I decided to switch carrers and today I can't see my future away from the lines of code.",
    ...
    professionalResume: {
      ...
      resume: {
        en: "I'm a hardworking professional with 1 year experience and skills in modern technologies.I'm a self-taught person who is always looking for some new knowledge. I'm also super adaptable and I've no problems in learning new Technologies. I had and still have a great relationship of friendship and communication in all the teams that I've worked with, I love sharing knowledge with my teammates. I believe in the theory that says “there isn't something we can't do, there's something we haven't learned yet”, and if I don't know it, I'll do my best to find a solution out.",
    ...
    softSkills: {
      ...
      description: {
        en: "Soft skills are the capabilities and abilities related to human behavior. So, they are considered necessary for a professional to achieve his professional goals, which he establishes for his career.",
      ...
      skill: [
        {
          ...
          description: {
            en: "I'm a person who has no problem communicating with other people, always giving my best to be efficient and the receiver always understands what was said. I love to improve this skill by teaching and answering questions from work friends.",
        ...
        },
        {
          ...
          description: {
            en: "Everything I plan to do, whether study or work, I always do it with dedication and hard work, giving my best for the best results. ",
        ...
        },
        {
          ...
          description: {
            en: "I've been improving this skill for the last 11 years, I work with data and information using a critical sense, bringing solutions to solve everyday challenges and I always base my decisions on facts.",
        ...
        },
        {
          ...
          description: {
            en: "I'm always adapting myself to changes, I love receiving criticism and I turn it into reflections for self improvement, appreticeship and new opportunities, I'm receptive and I don't lose focus on the goals.",
        ...
        },
        {
          ...
          description: {
            en: "I'm a good person and I always seek for doing the right thing. This is one of my main skills. I believe my attitudes demonstrate who I really am.",
        ...
        },
        {
          ...
          description: {
            en: "I believe that collaboration is certainly not suitable for every task and situation. Collaboration is, however, important to get the best results for multifaceted projects and complex problems. To succed on a project, it is important to identify when and how to collaborate. I also recognize my limitations and ask for help when it's needed or provide help to those who are somehow in need.",
        ...
        },
        {
          ...
          description: {
            en: " I've started to bring this skill to perfection in the last few years. When I reach my limit, I take a break and reflect,for a moment, thereafter, I make a decision on what to do next. I also like using the Promodoro technique to work more efficiently.",
        ...
        },
        {
          ...
          description: {
            en: "I started my studies trajectory in 2020, due to college and courses being online, I started to improve my ability to study and learn on my own. Today I love studying and reading technology documentation and consuming content from forums or blogs.",
    ...
    hardSkills: {
      ...
      description: {
        en: "Hard skills are the capabilities and technical knowledge, acquired through certifications, degrees, diplomas and proven experience in a particular area of expertise.",
  ...
  contact: {
    ...
    info: {
      en: "Get in touch through the application form or through one of our contacts. I will reply as soon as possible.",
  ...
  notFound: {
    ...
    text: {
      ...
      pt: "Ooops! Página não encontrada."
    }
  },
  footer: {
