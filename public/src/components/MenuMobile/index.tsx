        ...
        <li>
          <Link to={"/portfolio"} onClick={handleClickMenu}>
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path className="fill" d="M3 6V19" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path className="fill" d="M12 6V19" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path className="fill" d="M21 6V19" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <p>Portfolio</p>
          </Link>
        </li>
