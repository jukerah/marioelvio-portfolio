                ...
                <li>
                    ...
                    >
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M3 6V19" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill={(theme.mode.status === 'dark') ? 'var(--white)' : 'var(--limed-spruce)'}/>
                            <path d="M12 6V19" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill={(theme.mode.status === 'dark') ? 'var(--white)' : 'var(--limed-spruce)'}/>
                            <path d="M21 6V19" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill={(theme.mode.status === 'dark') ? 'var(--white)' : 'var(--limed-spruce)'}/>
                        </svg>
                        <p>Portfolio</p>
                    </Link>
                </li>
